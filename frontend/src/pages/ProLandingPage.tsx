            ...
            <div className="text-center mt-16">
              <div className="bg-gradient-to-br from-[#1E3253]/80 to-[#2A3F6C]/80 backdrop-blur-sm p-8 rounded-2xl border border-[#c5a572]/30 shadow-xl hover:shadow-2xl hover:shadow-[#c5a572]/20 transition-all duration-500">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <button
                    onClick={() => window.open('/chrome_extension/francis-teams-automatic.zip', '_blank')}
                ...
                <div className="mt-6 text-sm text-gray-400">
                  <p>✅ Compatible Windows, macOS, Linux</p>
                  <p>✅ Installation automatique en 30 secondes</p>
                  <p>✅ Fonctionne avec Google Chrome</p>
                </div>
              </div>
            </div>
