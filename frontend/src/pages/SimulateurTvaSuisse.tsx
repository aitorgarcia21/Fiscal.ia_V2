...
interface SimulationData {
  montantHT: number;
  typeTVA: 'normal' | 'reduit' | 'particulier';
}
...
export function SimulateurTvaSuisse() {
  ...
  const calculerTVA = (data: SimulationData): ResultatSimulation => {
    ...
    if (typeTVA === 'particulier') {
      conseils.push("Taux particulier pour l'hébergement touristique");
    }
      ...
      <header className="bg-[#0A1628]/95 backdrop-blur-sm border-b border-[#c5a572]/20 sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center gap-3">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-white text-xl">Francis Suisse</span>
          </Link>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Calculateur TVA Suisse</h1>
            <p className="text-gray-400 text-lg">
              Calculez la TVA fédérale suisse (7.7%, 2.5%, 3.7%)
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  <option value="normal">TVA normale (7.7%)</option>
                  <option value="reduit">TVA réduite (2.5%)</option>
                  <option value="particulier">TVA particulière (3.7%)</option>
                </select>
              </div>
                ...
                <div className="bg-[#162238]/50 rounded-xl p-6 border border-[#c5a572]/20">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-white font-semibold">{resultat.montantHT.toLocaleString('fr-CH')} CHF</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-white font-semibold">{resultat.montantTVA.toLocaleString('fr-CH')} CHF</span>
                    </div>
                    
                    <div className="border-t border-[#c5a572]/20 pt-4">
                      <div className="flex justify-between items-center">
                        <span className="text-white font-bold text-lg">Total TTC:</span>
                        <span className="text-[#c5a572] font-bold text-xl">{resultat.montantTTC.toLocaleString('fr-CH')} CHF</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-300 text-sm">
                  Ce calculateur utilise les taux de TVA fédéraux suisses. 
                  Certains cantons peuvent appliquer des taux différents. 
