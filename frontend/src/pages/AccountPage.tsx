              ...
              <div className="bg-gradient-to-r from-green-500/20 to-green-600/20 border border-green-500/30 rounded-xl p-6 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-green-300">Votre accès à Francis est pleinement fonctionnel</p>
                  </div>
                </div>
              </div>
            ...
            <div className="p-8">
              ...
              <div className="bg-[#162238]/50 rounded-xl p-6 mb-6 border border-[#c5a572]/20">
                ...
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <p className="text-white font-medium">Plan Francis Premium</p>
                    <p className="text-gray-400">9,99€ / mois</p>
                  </div>
