...
interface SimulationData {
  montantHT: number;
  typeIGI: 'normal' | 'reduit' | 'superreduit';
}
...
export function SimulateurIgiAndorre() {
  ...
  const calculerIGI = (data: SimulationData): ResultatSimulation => {
    const { montantHT, typeIGI } = data;
    ...
    const montantIGI = montantHT * (tauxIGI / 100);
    const montantTTC = montantHT + montantIGI;
    ...
    if (typeIGI === 'superreduit') {
      conseils.push("Taux super-réduit pour les produits de base");
    }

    return {
      montantHT,
      montantIGI: Math.round(montantIGI * 100) / 100,
  ...
  const handleSimuler = () => {
    const result = calculerIGI(simulation);
    setResultat(result);
  };
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Calculateur IGI Andorre</h1>
            <p className="text-gray-400 text-lg">
              Calculez l'Impost General Indirecte (4.5%, 1%, 0.5%)
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <select
                  value={simulation.typeIGI}
                  onChange={(e) => setSimulation({...simulation, typeIGI: e.target.value as any})}
                  ...
                  aria-label="Type d'IGI"
                >
                  <option value="normal">IGI normal (4.5%)</option>
                  <option value="reduit">IGI réduit (1%)</option>
                  <option value="superreduit">IGI super-réduit (0.5%)</option>
                </select>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-[#162238]/50 rounded-xl p-6 border border-[#c5a572]/20">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300">Taux IGI:</span>
                      <span className="text-[#c5a572] font-semibold">{resultat.tauxIGI}%</span>
                    </div>
                    
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300">Montant IGI:</span>
                      <span className="text-white font-semibold">{resultat.montantIGI.toLocaleString('fr-FR')} €</span>
                    </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-300 text-sm">
                  Ce calculateur utilise les taux IGI andorrans. 
