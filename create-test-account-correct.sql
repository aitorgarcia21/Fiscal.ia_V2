-- Script CORRIGÉ avec les bonnes colonnes pour créer un compte TEST Francis Andorre
...
BEGIN
    ...
    -- Créer ou mettre à jour le profil Francis Andorre avec les BONNES colonnes
